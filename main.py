...
def handle_verification(msg):
    ...
    if msg.text.strip() == expected:
        # Forward user's message to @puneet and @choudhary
        try:
            ...
            # If forwarding fails, optionally log or ignore
        ...
        if step == 1:
            ...
            bot.reply_to(msg,
                ...
                "⏳ _Please give us 5–10 minutes to verify your activity._\n\n"
                "Once verified, your *₹200 bonus* will be automatically credited.\n\n"
                "Stay tuned — we appreciate your patience!",
                parse_mode="Markdown"
            )
    else:
        bot.reply_to(msg,
